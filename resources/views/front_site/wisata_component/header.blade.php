  ...
  <div
   class="relative shadow-md text-white py-16 md:py-20 bg-gradient-to-r from-blue-600 via-teal-500 to-emerald-500">
    <div class="max-w-7xl mx-auto px-4">
      <h2 class="text-3xl md:text-5xl font-extrabold text-center">Wisata</h2>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-4 pt-12 pb-16">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        @foreach($wisatas as $wisata)
          <a href="{{ route('home.wisata.show', $wisata->slug) }}" 
              ...
              <div class="overflow-hidden">
                  <img src="{{ asset('image_wisata/' . $wisata->image) }}" alt="{{ $wisata->farm }}" class="aspect-[16/9] object-cover w-full transition-transform duration-500 group-hover:scale-110">
              </div>
              ...
              <div class="p-6 flex flex-col">
                  ...
                  <p class="mt-3 text-gray-600 leading-relaxed text-sm">
                      {{ \Illuminate\Support\Str::limit(strip_tags($wisata->content), 120) }}
                  </p>
                  <div class="mt-5">
