    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
      <a href="#" class="bg-white rounded-xl shadow border hover:shadow-lg hover:scale-105 hover:border-green-400 hover:bg-green-50 transition duration-300 ease-in-out mt-8">
        <img src="{{ asset('img/tanah.jpg')}}"
            ...
            class="w-full aspect-[16/9] object-cover rounded-t-lg transition-transform duration-300 group-hover:scale-105">
        <div class="p-6 flex-1 flex flex-col">
          ...
          <div class="mt-auto pt-6">
            <h1 class="font-bold text-green-500">Pengumuman</h1>
